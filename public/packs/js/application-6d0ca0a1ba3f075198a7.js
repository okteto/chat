...
/* harmony import */ var channels_consumer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! channels/consumer */ "./app/javascript/channels/consumer.js");
...
function subscribeConsumerWithStimulusContext(ctx) {
  channels_consumer__WEBPACK_IMPORTED_MODULE_1__["default"].subscriptions.create("MessagesChannel", {
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function insertMessage(message) {
      ...
      var username = this.data.get("username");
      var lastMessageRow = document.getElementById("message-".concat(message.id)).parentElement;
    ...
    key: "insertPreview",
    value: function insertPreview(preview) {
      var message = document.getElementById("message-".concat(preview.message_id));

      if (message) {
        var previews = message.querySelector(".previews");
    ...
    key: "clearForm",
    value: function clearForm(author) {
...
_default.targets = ["messages", "form"];
...
/******/ });
//# sourceMappingURL=application-6d0ca0a1ba3f075198a7.js.map